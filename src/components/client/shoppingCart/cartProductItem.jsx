...
const CartProductItem= ({livre})=> {
    ...
    <article className="col-sm-3 mt-5">
       ...
       <div className="flex"> <Rating style={{ maxWidth: 100 }} value={5} /> </div>
       </div>
       </div>
      <div className="text-center">  
      ...
      <div className="text-center">
        <button className="btn btn-warning" disabled={livre.qtestock <= 1} onClick={() => addToCart(livre)}>
          Add to cart
        </button>
        </div>
    </article>
